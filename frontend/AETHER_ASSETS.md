...
| coin | Resource | Cash and currency | 24-48 | Integrated | Internal SVG |
| asset-crystal | Resource | Asset totals | 24-48 | Integrated | Internal SVG |
| debt-shard | Resource | Liability totals | 24-48 | Integrated | Internal SVG |
| net-worth-core | Resource | Net worth | 24-48 | Integrated | Internal SVG |
...
Use `REVISION REQUIRED` for assets that are wired but need art direction or small-size readability changes. P0 assets are currently `INTEGRATED`; they still require visual review before approval.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| coin | Resource | Integrated | `/aether/icons/resources/coin.webp` | 256x256 | WebP | Yes | Dashboard monthly income / cash resource | Internal SVG | Aged brass financial token with dark steel inset and controlled cyan Aether core. |
| asset-crystal | Resource | Integrated | `/aether/icons/resources/asset-crystal.webp` | 256x256 | WebP | Yes | Accounts asset total | Internal SVG | Stable emerald/cyan crystal held by a dark steel arcane cradle. |
| debt-shard | Resource | Integrated | `/aether/icons/resources/debt-shard.webp` | 256x256 | WebP | Yes | Accounts liability total | Internal SVG | Fractured ruby/obsidian liability shard with broken dark steel restraints. |
| net-worth-core | Resource | Integrated | `/aether/icons/resources/net-worth-core.webp` | 256x256 | WebP | Yes | Accounts net worth | Internal SVG | Amber arcane balance core surrounded by aged brass and dark steel rings. |
...
- `coin`: integrated, awaiting visual review.
- `asset-crystal`: integrated, awaiting visual review.
- `debt-shard`: integrated, awaiting visual review.
- `net-worth-core`: integrated, awaiting visual review.
