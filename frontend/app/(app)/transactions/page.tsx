...
import { apiFetch, money, problemMessage, type AccountDto, type CategoryDto, type PagedTransactionsDto, type TransactionStatus, type TransactionType } from "@/lib/api-client";
...
export default function TransactionsPage() {
  ...
  async function load() {
    ...
    try {
      ...
      const [nextData, nextAccounts, incomeCategories, expenseCategories] = await Promise.all([
